...
import dev.nikho.net.ParticleEffect.ParticleData;
import dev.nikho.net.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	...
	DRAGON_BREATH("dragonbreath", 42, -1, ParticleProperty.DIRECTIONAL),
	ENDROD("endrod", 43, -1, ParticleProperty.DIRECTIONAL),
	DAMAGE_INDICATOR("damageindicator", 44, -1, ParticleProperty.DIRECTIONAL),
	FALLING_DUST("fallingdust", 45, -1, ParticleProperty.DIRECTIONAL),
	SPLIT("split", 46, -1, ParticleProperty.DIRECTIONAL),
	TOTEM("totem", 47, -1, ParticleProperty.DIRECTIONAL);
	...
	public static final class ParticlePacket {
		...
		public static void initialize() throws VersionIncompatibleException {
			...
			try {
				version = ReflectionUtils.getVersionMinor();
				if (version > 7) {
